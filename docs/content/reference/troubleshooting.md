...
Most of these come down to network reality or how stapi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

stapi rate-limits like any public site. stapi already paces
...
Where a surface is gated, stapi reads a cookie or token you supply
...
`stapi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what stapi actually did
